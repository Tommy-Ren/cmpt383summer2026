...
# TODO 1 Write a program that uses a loop to set the variable named result to be
# the list [1, 2, 3, 4, 5]. Use a loop to add the numbers.
...
# TODO 2 Write a program that uses a loop to set the variable named result to be
# the list [1, 2, 3, 4, 5]. Use a list comprehension to add the numbers.

result = [i for i in range(1, 6)]
print('TODO 2:', result) # [1, 2, 3, 4, 5]

# TODO 3 Write a program that uses a loop to set the variable named result to be
# the list [1, 4, 9, 16, 25], i.e. the squares of the numbers 1 to 5. Use a loop
# to add the squares of the numbers.
...
# TODO 10 Re-do the previous question, but this type print the list as a nicely
